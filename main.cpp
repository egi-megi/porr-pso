...
int main() {
    ...
    Swarm s1a(300, 20, new ConfigEx1(-40, 40));
    Particle theBestParticle1a = s1a.findTheBestParticle(0.8, 1.0, 0.1, 0.1, new ConfigStopCriterionAcademic());

    //Swarm s1n(100, 10, new ConfigEx1(-40, 40));
    //Particle theBestParticle1n = s1n.findTheBestParticle(0.5, 1.0, 0.1, 0.1, new ConfigStopCriterionNormal());

    //Swarm s2a(100, 4, new ConfigEx2(-1, 1));
    //Particle theBestParticle2a = s2a.findTheBestParticle(1, 0.1, 0.1, 0.1, new ConfigStopCriterionAcademic());

    //Swarm s2n(100, 4, new ConfigEx2(-1, 1));
