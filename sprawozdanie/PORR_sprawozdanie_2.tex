...
\begin{minipage}[b]{\dimexpr.5\textwidth-1em}
  \centering
  \includegraphics[width=1\linewidth]{grafiki2/CUDA/CUDA_PSO_T1_koszt_linear.png}
  \captionof{figure}{Wartość funkcji kosztu dla zadania $1$ dla algorytmu PSO.}
  \label{fig:pozycjeStartowe:PSO1CUDA}
\end{minipage} \hfill
\begin{minipage}[b]{\dimexpr.5\textwidth-1em}
  \centering
  \includegraphics[width=1\linewidth]{grafiki2/CUDA/CUDA_MC_T1_koszt_linear.png}
  \captionof{figure}{Wartość funkcji kosztu dla zadania $1$ dla algorytmu Monte Carlo.}
  \label{fig:pozycjeStartowe:MC1CUDA}
\end{minipage}
\end{figure}
...
\begin{minipage}[b]{\dimexpr.5\textwidth-1em}
  \centering
  \includegraphics[width=1\linewidth]{grafiki2/CUDA/CUDA_PSO_T2_koszt_linear.png}
  \captionof{figure}{Wartość funkcji kosztu dla zadania $2$ dla algorytmu PSO.}
  \label{fig:pozycjeStartowe:PSO2CUDA}
\end{minipage} \hfill
\begin{minipage}[b]{\dimexpr.5\textwidth-1em}
  \centering
  \includegraphics[width=1\linewidth]{grafiki2/CUDA/CUDA_PSO_T2_koszt_log.png}
  \captionof{figure}{Wartość funkcji kosztu w skali logarytmicznej dla zadania $2$ dla algorytmu PSO.}
  \label{fig:pozycjeStartowe:PSO2CUDAlog}
\end{minipage}
\end{figure}
...
\begin{minipage}[b]{\dimexpr.5\textwidth-1em}
  \centering
  \includegraphics[width=1\linewidth]{grafiki2/CUDA/CUDA_MC_T2_koszt_linear.png}
  \captionof{figure}{Wartość funkcji kosztu dla zadania $2$ dla algorytmu Monte Carlo.}
  \label{fig:pozycjeStartowe:MC2CUDA}
\end{minipage} \hfill
\begin{minipage}[b]{\dimexpr.5\textwidth-1em}
  \centering
  \includegraphics[width=1\linewidth]{grafiki2/CUDA/CUDA_MC_T2_koszt_log.png}
  \captionof{figure}{Wartość funkcji kosztu w skali logarytmicznej dla zadania $2$ dla algorytmu Monte Carlo.}
  \label{fig:pozycjeStartowe:MC2CUDAlog}
\end{minipage}
\end{figure}
