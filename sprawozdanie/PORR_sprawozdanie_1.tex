...
\begin{minipage}[b]{\dimexpr.5\textwidth-1em}
  ...
  \captionof{figure}{Trajektoria najlepszej cząsteczki o wymierze $n=2$ dla zadania $1$ dla metody PSO.}
  \label{fig:skalowalnosc:PSO1}
\end{minipage} \hfill
\begin{minipage}[b]{\dimexpr.5\textwidth-1em}
  \centering
  \includegraphics[width=1\linewidth]{grafiki/Wykresy2d/zad1_MC_plot_BEST.svg}
  \captionof{figure}{Trajektoria najlepszej cząsteczki o wymierze $n=2$ dla zadania $1$ dla metody Monte Carlo.}
  \label{fig:skalowalnosc:PSO2}
\end{minipage}
\end{figure}
...
\begin{minipage}[b]{\dimexpr.5\textwidth-1em}
  \centering
  \includegraphics[width=1\linewidth]{grafiki/Wykresy2d/zad2_pso_plot_BEST.svg}
  \captionof{figure}{Trajektoria najlepszej cząsteczki o wymierze $n=2$ dla zadania $2$ dla metody PSO.}
  \label{fig:skalowalnosc:MC1}
\end{minipage} \hfill
\begin{minipage}[b]{\dimexpr.5\textwidth-1em}
  \centering
  \includegraphics[width=1\linewidth]{grafiki/Wykresy2d/zad2_MC_plot_BEST.svg}
  \captionof{figure}{Trajektoria najlepszej cząsteczki o wymierze $n=2$ dla zadania $2$ dla metody Monte Carlo.}
  \label{fig:skalowalnosc:MC2}
\end{minipage}
\end{figure}
